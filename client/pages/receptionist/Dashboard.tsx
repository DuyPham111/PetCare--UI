            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="grid gap-6 mb-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{invoicesToday}</div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4 p-3 border rounded-lg">
                                ...
                                <div className="flex-1">
                                    <p className="font-medium">John Smith checked in</p>
                                    <p className="text-sm text-muted-foreground">For grooming appointment</p>
                                </div>
                            ...
                            <div className="flex items-center gap-4 p-3 border rounded-lg">
                                <Activity className="h-5 w-5 text-muted-foreground" />
                                <div className="flex-1">
                                    <p className="font-medium">Invoice #1234 generated</p>
                                    <p className="text-sm text-muted-foreground">Sarah Johnson - $150.00</p>
                                </div>
                            ...
                            <div className="flex items-center gap-4 p-3 border rounded-lg">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-muted-foreground">Mike Davis - Vet consultation</p>
                                </div>
